...
/**
 * The shell which takes the input from the user.
 */
...
public class Shell {
    ...
    public void start() {
        ...
        while(bRun) {
            ...
            //hantera parent här mha m_Filesystem.pwd()
            sCommand = readLine();
            ...
            {}
                ...
                switch(nIndex) {
                    case 0: // quit = Exit the program
                        return;

                    case 1: // format = Formats the virtual disk
                    ...
                    case 2: // ls = Show the content of a folder
                        if(asCommandArray.length == 1)
                    ...
                    case 3: // create = A file is created, text is added to it afterwards
                        if(asCommandArray.length != 2)
                    ...
                    case 4: // cat = Print the content of a file
                        if(asCommandArray.length != 2)
                    ...
                    case 5: // save = Save the virtual memory on a (real) file
                        if(asCommandArray.length != 2)
                    ...
                    case 6: // read = Open (real) file and load content to virtual memory
                        if(asCommandArray.length != 2)
                    ...
                    case 8: // copy = Copy a file to a destination
                    ...
                    case 9: // append = Append the content of a file to another
                        if(asCommandArray.length != 2)
                            System.out.println("Usage: append <source> <destination>");
                        else
                            System.out.println(m_Filesystem.append(split(asCommandArray[1], '/')));
                        break;
                    
                    case 10: // rename = Rename a file
                        if(asCommandArray.length != 3)
                    ...
                    case 11: // mkdir = Create a new folder
                        if(asCommandArray.length != 2)
                    ...
                    case 12: // cd = Change the current working directory to a specific folder
                        if(asCommandArray.length != 2)
                    ...
                    case 13: // pwd = Print the path to where you're currently working
                        if(asCommandArray.length != 1)
                    ...
                    case 14: // help = Shows how to use all the available commands
                        printHelp();
                        break;
    ...
    private void printHelp()
    {
        ...
        System.out.println("* append <source>:                  Appends contents to <path>");
    ...
    private byte[] readBlock() {
        byte[] abTempBuffer = new byte[490];
        byte bTemp;
        boolean bEnter = false;
        
        for(int nIndex = 0; nIndex < 490; nIndex++) {
            try {
